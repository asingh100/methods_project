...
```
With the plots, we observe that there actually just 3 interactions and there appears to be a significant interaction between urbanization and percent_pop with high school degree.

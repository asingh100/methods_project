...
model_1 = lm(hate_crimes_per_100k_splc ~ gini_index*urbanization, data = crime_trans)
broom::tidy(model_1)
interact_plot(model_1, pred = gini_index, modx = urbanization)

model_2 = lm(hate_crimes_per_100k_splc ~ perc_population_with_high_school_degree*urbanization, data = crime_trans)
broom::tidy(model_2)
summary(model_2)
interact_plot(model_2, pred = perc_population_with_high_school_degree, modx = urbanization)

model_3 = lm(hate_crimes_per_100k_splc ~ perc_non_citizen*unemployment, data = crime_trans)
broom::tidy(model_3)
summary(model_3)
interact_plot(model_3, pred = perc_non_citizen, modx = unemployment)

model_4 = lm(hate_crimes_per_100k_splc ~ perc_population_with_high_school_degree*urbanization, data = crime_trans)
broom::tidy(model_4)
summary(model_4)
interact_plot(model_4, pred = perc_population_with_high_school_degree, modx = urbanization)
```
...
fit = lm(hate_crimes_per_100k_splc ~ perc_population_with_high_school_degree, data = crime_trans)
summary(fit)
...
Check 3_way interactions between predictors
...
Conclusion: There are no significant interactions between the predictors.
